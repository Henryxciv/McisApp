...
//  McisApp
//
//  Created by Henry Akaeze on 11/28/17.
...
class ChatVC: JSQMessagesViewController {
    ...
    private lazy var userIsTypingRef: DatabaseReference =
        self.chatRef.child("typingIndicator").child(self.senderId)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.edgesForExtendedLayout = []        //to make message text view show
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, attributedTextForMessageBubbleTopLabelAt indexPath: IndexPath!) -> NSAttributedString! {
        ...
        if name == DataServices.ds.user._fname + " " + DataServices.ds.user._lname{
